...
// CHECK-DAG:       %[[VAL_4:.*]] = arith.constant 4 : i64
// Note: On x86, long double is f80, so complex literals use f80 args while stores use f64.
// We bind specifically to f64 constants for stores, and use wildcards for call args.
// CHECK-DAG:       %[[F64_ZERO:.*]] = arith.constant 0.000000e+00 : f64
// CHECK-DAG:       %[[F64_ONE:.*]] = arith.constant 1.000000e+00 : f64
// CHECK-DAG:       %[[VAL_9:.*]] = cc.alloca f64
// CHECK:           cc.store %[[F64_ZERO]], %[[VAL_9]] : !cc.ptr<f64>
...
// CHECK:           cc.store %[[F64_ONE]], %[[VAL_13]] : !cc.ptr<f64>
