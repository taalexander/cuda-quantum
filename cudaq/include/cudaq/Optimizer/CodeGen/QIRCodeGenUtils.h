...
/// Collect all device qubit ids borrowed from @mapped_wireset in op and its
/// nested regions. Returns a sorted, de-duplicated vector of device qubit
/// identities. Accepts any operation as root (e.g., FuncOp or ModuleOp).
