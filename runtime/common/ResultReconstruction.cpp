...
static cudaq::sample_result reconstructSampleResultFromFlatBitstringShotsImpl(
...
cudaq::sample_result cudaq::reconstructSampleResultFromCompactBitstringShots(
    const std::vector<std::string> &shots, const ResultOutputMap &resultMap) {
  return reconstructSampleResultFromFlatBitstringShotsImpl(
      shots, resultMap, BitCoordinate::ResultIndex);
}

cudaq::sample_result cudaq::reconstructSampleResultFromFlatBitstringShots(
    const std::vector<std::string> &shots, const ResultOutputMap &resultMap) {
  return reconstructSampleResultFromFlatBitstringShotsImpl(
      shots, resultMap, BitCoordinate::DeviceQubit);
}
...
cudaq::sample_result cudaq::reconstructSampleResultFromCompactMeasurements(
...
cudaq::sample_result cudaq::reconstructSampleResultFromDeviceMeasurements(
    const CountsDictionary &counts, const ResultOutputMap &resultMap) {
  return reconstructSampleResultFromCounts(counts, resultMap,
...
cudaq::sample_result cudaq::reconstructSampleResultFromLocalMeasurements(
    const CountsDictionary &counts, const ResultOutputMap &resultMap) {
  return reconstructSampleResultFromDeviceMeasurements(counts, resultMap);
}
