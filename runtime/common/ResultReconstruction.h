...
sample_result reconstructSampleResultFromCompactBitstringShots(
...
sample_result reconstructSampleResultFromCompactMeasurements(
    const CountsDictionary &counts, const ResultOutputMap &resultMap);

/// Reconstruct a sample_result from a counts dictionary whose bitstrings are
/// indexed by mapped device qubit.
sample_result
reconstructSampleResultFromDeviceMeasurements(const CountsDictionary &counts,
                                              const ResultOutputMap &resultMap);

/// Backward-compatible alias for local simulator/device measurements.
sample_result
