...
:doc:`Quake </_mdgen/Dialects/QuakeDialect>` represents quantum operations and
values, :doc:`CC </_mdgen/Dialects/CCDialect>` represents classical constructs
...
* Follow :doc:`mlir_pass` to implement, test, and integrate a compiler pass.
  ...
  :doc:`pass_plugins`.
* Browse :doc:`available_passes` for the complete list of registered
